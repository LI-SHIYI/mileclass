...
@allure.feature('feature老师管理')
@allure.story('story老师管理')
@allure.title('title老师管理')
@allure.description('description老师管理')
def test_index_lesson_live_init(login_organ):
    body = {"offset": 0, "pageSize": 10, "needTotalSize": True}
    url = get_organ_http_server() + '/k12/org/teacher/manage'
